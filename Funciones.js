...
window.addEventListener("scroll", function(){
    ...
    if(header.classList.toggle('active', window.scrollY >0)){
      drop[0].style.color= "white"; drop[1].style.color= "white"; drop[2].style.color= "white";
    }else{
      drop[0].style.color= "initial"; 
      drop[1].style.color= "initial"; 
      drop[2].style.color= "initial";
    }
})
...
const navMenu = document.querySelector("#navMovil");
